        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <img src="{{url('public/assets')}}/img/p6.png" alt="Images" width="20%">
              </td>
              <td class="product-name">
                <h2 class="h5 text-black">Apple Granny Smith</h2>
              </td>
              <td>RP.192.000</td>
              <td>
            ...
            <tr>
              <td class="product-thumbnail">
              <img src="{{url('public/assets')}}/img/p2.png" alt="Images" width="20%">
              </td>
              <td class="product-name">
                <h2 class="h5 text-black">Durian Monthong</h2>
              </td>
              <td>RP.380.000</td>
              <td>
                <div class="input-group mb-3" style="max-width: 120px;">
        ...
        <div class="col-md-7">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 text-right">
              <strong class="text-black">RP.572.000</strong>
            </div>
          </div>
          <div class="row mb-5">
            <div class="col-md-6">
